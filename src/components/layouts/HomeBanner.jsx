...
export default function HomeBanner() {
  return (
    <section className="h-[70vh] md:h-[80vh] overflow-hidden relative bg-gradient-to-t lg:bg-gradient-to-r from-black from-50% sm:from-30% md:from-10% via-black/80 to-transparent">
      <MainWrapper>
        <div className="w-11/12 sm:max-w-lg flex flex-col items-center text-center lg:text-left lg:items-start gap-6 absolute left-1/2 -translate-x-1/2 lg:left-auto lg:-translate-x-0 top-1/2 -translate-y-1/4 lg:-translate-y-1/2 text-white">
