        ...
        <section>
          {loading ? (
            ...
            <div className="carousel_contents" ref={carouselContainer}>
              {castData?.map((cast) => (
                <div key={cast.id} className="w-4/12 sm:w-3/12 md:w-2/12 flex-shrink-0 rounded-lg cursor-pointer flex flex-col md:gap-2 pb-2 overflow-hidden">
                  ...
                  <h1 className="flex flex-col gap-px px-2">
                    <strong className="text-white text-base md:text-lg 2xl:text-xl line-clamp-2">{cast.name}</strong>
